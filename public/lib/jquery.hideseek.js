      ...
      $this.keyup(function(e) {
        ...
        if (e.keyCode != 38 && e.keyCode != 40 && e.keyCode != 13) {
          ...
          $list.children($this.opts.ignore.trim() ? ":not(" + $this.opts.ignore + ")" : '').removeClass('selected').each(function() {
            ...
            //console.log($(this).find('.showtitle').text().toLowerCase());
            var data = $(this).find('.showtitle').text().toLowerCase();
            ...
            if (treaty) {
              ...
              $(this).show();
              $this.opts.highlight ? $(this).find('.showtitle').removeHighlight().highlight(q).show() : $(this).show();
